...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col gap-6 w-full h-[100vh] sm:w-[90%] md:w-[85%] lg:w-[85%] p-6 rounded shadow bg-white items-center mx-auto mt-10 text-center mb-12'>
      ...
      <button
        ...
        className='mt-8 px-4 py-1  min-md:px-8 min-md:py-3 bg-teal-600 hover:bg-teal-700 text-white text-lg font-medium rounded-xl shadow transition duration-200 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2'
